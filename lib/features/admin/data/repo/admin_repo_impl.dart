...
class AdminRepoImpl implements AdminRepo {
  ...
  Future<Either<Failure, Unit>> saveProduct({
    ...
    try {
      // Always multipart: it carries new photo files, kept-image URLs and the
      // full variant set in one request (with POST + _method spoofing on edit).
      final form = FormData();
      ...
      // Opt-in markers so the server replaces (and can clear) images/variants.
      field('sync_images', 1);
